...
- (void)setTextValue:(CGFloat)value
{
    ...
    else
    {
        ...
        else
        {
            ...
            if ([self.format isEqualToString:@"%.1f"]) {
                NSMutableAttributedString * noteStr = [[NSMutableAttributedString alloc]initWithString:[NSString stringWithFormat:@"%@%%",self.text]];
                if ([noteStr.string rangeOfString:@"."].length != 0) {
                    NSRange redRangeTwo = NSMakeRange([[noteStr string] rangeOfString:@"."].location, 3);
                ...
                NSMutableAttributedString * noteStr = [[NSMutableAttributedString alloc]initWithString:[NSString moneyFormatterWanYuanWithValue:[self.text doubleValue]]];
                if ([noteStr.string rangeOfString:@"."].length != 0) {
                    NSRange redRangeTwo = NSMakeRange([[noteStr string] rangeOfString:@"."].location, 3);
                    [noteStr addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:14] range:redRangeTwo];
                    [self setAttributedText:noteStr];
