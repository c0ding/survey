...
- (void)updateIndicators {
	...
	if (mode == MBProgressHUDModeIndeterminate) {
		if (!isActivityIndicator) {
            ...
            UIActivityIndicatorView* avi = (UIActivityIndicatorView *)self.indicator;
            
            if (@available(iOS 5.0, *)) {
                avi.color = [UIColor colorWithRed:110/255.0 green:165/255.0 blue:255 / 255.0 alpha:1];
            } else {
